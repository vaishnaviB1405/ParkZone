...
import com.parkzone.dto.EmailRequestDto;
...
public class EmailService {
	...
	private final String emailService = "http://localhost:5220/api/Otp/send-Email";
	private final String emailOtpService = "http://localhost:5220/api/Otp/send-otp";
	...
	public void sendReservationDtails(Reservation reservation)
	{
		...
		emailRequestDto.setBody(
				"<html><body>" +
					    ...
					    "<p><strong>Sincerely,</strong><br>ParkZone Pvt. Ltd.</p>" +
					    "</body></html>"
				);
	...
	public void sessionStartMail(Reservation reservation)
	{
		...
		emailRequestDto.setBody(
				"<html><body>"
		                ...
		                + "<p>Thank you for choosing ParkZone!</p>"
		                + "<p><strong>Sincerely,</strong><br>ParkZone Pvt. Ltd.</p>"
		                + "</body></html>"
				);
		HttpEntity<EmailRequestDto> request = new HttpEntity<>(emailRequestDto,headers);
	...
	public void sessionComplete(Reservation reservation, BigDecimal extraCharge)
	{
		...
		emailRequestDto.setBody("<html><body>"
		        ...
		        + "<p>Thank you for using ParkZone.</p>"
		        + "<p><strong>Sincerely,</strong><br>ParkZone Pvt. Ltd.</p>"
		        + "</body></html>"
				);
		HttpEntity<EmailRequestDto> request = new HttpEntity<>(emailRequestDto,headers);
